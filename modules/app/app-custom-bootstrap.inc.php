...
define('SMART_APP_MODULES_RELEASE', 'r.2016.08.09'); // this can be used for tracking changes to custom app modules
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.2.3.5.2'); // this must be used to validate the required minimum framework version

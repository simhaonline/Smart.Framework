...
define('SMART_APP_MODULES_RELEASE', 'm.180508'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.3.7.5.r.2018.05.08'); // this must be used to validate the required minimum framework version

...
define('SMART_APP_MODULES_RELEASE', 'm.sf.2019-04-18'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.3.7.8.r.2019.04.18'); // this must be used to validate the required minimum framework version

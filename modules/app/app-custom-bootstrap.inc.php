...
define('SMART_APP_MODULES_RELEASE', 'r.2017.02.02'); // this can be used for tracking changes to custom app modules
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.2.3.7.6'); // this must be used to validate the required minimum framework version

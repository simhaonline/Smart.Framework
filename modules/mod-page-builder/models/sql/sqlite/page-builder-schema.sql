...
-- START :: SQLite: PageBuilder r.20200717 #
...
INSERT INTO `_smartframework_metadata` (`id`, `description`) VALUES ('version@page-builder', 'v.2020.07.17');

-- Table Structure: Page-Builder #

CREATE TABLE 'page_builder' ( 								-- Web - Page Builder v.2020.07.17
...
CREATE TABLE 'page_translations' ( 							-- Web - Page (Builder) Translations v.2020.07.17

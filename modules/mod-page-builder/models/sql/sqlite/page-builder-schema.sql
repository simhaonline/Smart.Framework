...
-- START :: SQLite: PageBuilder r.20191109 #
...
INSERT INTO `_smartframework_metadata` (`id`, `description`) VALUES ('version@page-builder', 'v.2019.11.09');

-- Table Structure: Page-Builder #

CREATE TABLE 'page_builder' ( 								-- Web - Page Builder v.2019.11.09
...
CREATE TABLE 'page_translations' ( 							-- Web - Page (Builder) Translations v.2019.11.09

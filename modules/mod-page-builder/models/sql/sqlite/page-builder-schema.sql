...
-- START :: SQLite: PageBuilder r.20200817 #
...
INSERT INTO `_smartframework_metadata` (`id`, `description`) VALUES ('version@page-builder', 'v.2020.08.17');

-- Table Structure: Page-Builder #

CREATE TABLE 'page_builder' ( 								-- Web - Page Builder v.2020.08.17
...
CREATE TABLE 'page_translations' ( 							-- Web - Page (Builder) Translations v.2020.08.17

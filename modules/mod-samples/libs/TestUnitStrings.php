<?php
// [LIB - SmartFramework / Samples / Test (Unicode) Strings]
...
final class TestUnitStrings {
	...
	public static function testUnicode() {
		...
		if((string)$err == '') {
			...
			$text_info = '<h2><span style="color:#FF5500;">A test FAILED</span> when testing Unicode String Tests.<span style="color:#FF5500;"><hr>FAILED Test Details</span>:</h2><br><h3>'.\Smart::escape_html($tests[\Smart::array_size($tests)-1]).'</h3><br><span style="font-size:14px;"><pre>'.\Smart::escape_html($err).'</pre></span>';
		} //end if else
		//--

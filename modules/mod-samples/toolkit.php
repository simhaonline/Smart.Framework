...
class SmartAppIndexController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		//--
		$fcontent = (string) SmartFileSystem::staticread('lib/framework/css/ux-toolkit-samples.html');
		...
		$this->PageViewSetVars([
			...
			'main'	=> (string) '<h1 style="font-size:3em !important; display: inline !important;">Smart Framework / UI Toolkit Plugins - Demo<br><span style="color:#778899; font-size:70%; font-weight:normal;"><span style="cursor:help;" title="UX Toolkit is built into the Smart.Framework and provided as the default UI Toolkit. You can use it or not ... If you prefer you can use other UI Toolkits such as: UiKit, Bootstrap, PureCSS, jQueryUI or any other you may like !"><i>UX Toolkit</i> (built-in)</span>, a very lightweight <span style="cursor:help;" title="This size is calculated when the CSS is minified ...">(~15KB)</span>, CSS only, responsive front-end Toolkit for web interfaces &nbsp; <span style="cursor:help;" title="http://purecss.io"><i><sup>inspired from Pure.css UI Toolkit</sup></i></span></span></h1><hr>'.trim((string)$fcontent).'<hr><br><br>'
		]);
		//--
		$fcontent = ''; // free mem
		//--

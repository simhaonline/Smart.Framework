...
# Combine all required Smart.Framework JS source scripts from lib/js/framework/src/*.js into one package JS file: lib/js/framework/smart-framework.js
...
echo "// Included Files: browser_check.js ; core_utils.js ; arch_utils.js ; crypt_utils.js ; ifmodalbox.js ; browser_utils.js ; ifmodalbox_scanner.js ; validate_input.js #" >> ${THE_FILE}
echo "" >> ${THE_FILE}
echo "// ### DO NOT EDIT THIS FILE AS IT WILL BE OVERWRITTEN EACH TIME THE RELATED SOURCES WILL CHANGE !!! ###" >> ${THE_FILE}

...
# Combine all required Smart.Framework JS source scripts from lib/js/framework/src/*.js into one package JS file: lib/js/framework/smart-framework.js # r.20190117

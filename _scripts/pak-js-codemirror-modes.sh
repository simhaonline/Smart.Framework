...
echo "// Included Modes: diff/diff.js ; javascript/javascript.js ; css/css.js ; sass/sass.js ; xml/xml.js ; htmlmixed/htmlmixed.js ; markdown/markdown.js ; yaml/yaml.js ; sql/sql.js ; clike/clike.js ; php/php.js ; toml/toml.js ; rust/rust.js ; go/go.js ; lua/lua.js ; ruby/ruby.js ; perl/perl.js ; python/python.js ; shell/shell.js ; asciiarmor/asciiarmor.js ; spreadsheet/spreadsheet.js #" >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}
...
echo "// ===== sass/sass.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/sass/sass.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}
...
echo "// ===== rust/rust.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/rust/rust.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}
...
echo "// ===== lua/lua.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/lua/lua.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}

echo "// ===== ruby/ruby.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/ruby/ruby.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}

echo "// ===== perl/perl.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/perl/perl.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}

echo "// ===== python/python.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/python/python.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}
...
echo "// ===== asciiarmor/asciiarmor.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/asciiarmor/asciiarmor.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}

echo "// ===== spreadsheet/spreadsheet.js" >> ${THE_JS_FILE}
cat ../lib/js/jseditcode/codemirror/mode/spreadsheet/spreadsheet.js >> ${THE_JS_FILE}
echo "" >> ${THE_JS_FILE}

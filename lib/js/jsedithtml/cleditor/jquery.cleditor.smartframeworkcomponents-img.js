...
if(CLEditor_SmartFrameworkComponents_fileBrowserCallURL != '') {
	CLEditor_SmartFrameworkComponents_fileBrowserImgLibBttn = '<button class="ux-button ux-button-small ux-button-secondary" style="width:215px;" onClick="SmartJS_BrowserUtils.PopUpLink(CLEditor_SmartFrameworkComponents_fileBrowserCallURL, \'wnd__net__filemanager_imgsel\', 920, 560, 1); return false;" title="Pick-up an Image from Library">Browse the Image Library</button>';
} //end if else
//--
...
//		  '<td align="center"><input id="CLEditor__FileManager__TitleSmartFrameworkComponents" type="text" class="ux-field" value="" maxlength="255" placeholder="Title Text" title="Title Text" style="width:210px;"></td>' +
		  ...
		  '</tr>' +
		  '</table><br><div id="CLEditor__FileManager__SmartFrameworkComponents" style="width:480px; height:auto; min-height:20px; max-height:320px; background:#FFFFFF; border:1px solid #ECECEC; overflow:auto;"></div>'
		  ,

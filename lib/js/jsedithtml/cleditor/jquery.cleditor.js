...
//				} //end if
	...
	function refresh(editor) {
		...
		doc.write(
			options.docType +
			'<html>' +
			((options.docCSSFile === '') ? '<head><link rel="stylesheet" type="text/css" href="' + editorPath() + 'jquery.cleditor.smartframeworkcomponents.css"></head>' : '<head><link rel="stylesheet" type="text/css" href="' + options.docCSSFile + '"></head>') +

...
this.MaximizeElement = function(id) {
	//--
	$('#' + id).before('<div align="right" style="position:relative; width:' + parseInt($('#' + id).width()) + 'px; height: 22px; background: #FCFCFC; border: 1px solid #DDDDDD; border-bottom: 0; text-align: center; z-index: 2;">' + '<span style="cursor:pointer;" title="Toggle Full Screen" onClick="if($(this).data(\'fullscreen\') == \'fullscreen\') { $(this).data(\'fullscreen\', \'default\'); $(this).parent().css({ position: \'relative\', top:0, left:0, width: Math.max(parseInt($(this).data(\'width\')),100), height:\'22px\', \'z-index\':2 }); $(\'#' + SmartJS_CoreUtils.escape_js(id) + '\').css({ position: \'relative\', top:0, left:0, width: Math.max(parseInt($(this).data(\'width\')),100), height: Math.max(parseInt($(this).data(\'height\')),100), \'z-index\':1 }); } else { $(this).data(\'width\', \'' + SmartJS_CoreUtils.escape_js($('#' + id).width()) + '\'); $(this).data(\'height\', \'' + SmartJS_CoreUtils.escape_js($('#' + id).height()) + '\'); $(this).data(\'fullscreen\', \'fullscreen\'); $(this).parent().css({ position: \'fixed\', top:0, left:0, width:\'100%\', height:\'22px\', \'z-index\':99999 }); $(\'#' + SmartJS_CoreUtils.escape_js(id) + '\').css({ position: \'fixed\', top:\'23px\', left:0, width:\'100%\', height:(parseInt($(window).height())-23), \'z-index\':99998 }); }"><img src="' + SmartJS_CoreUtils.escape_html(SmartJS_BrowserUtils_FullScreen_Img) + '"></span>' + '</div>').css({ position: 'relative', border: '1px solid #DDDDDD', 'z-index': 1 });
	//--
} //END FUNCTION

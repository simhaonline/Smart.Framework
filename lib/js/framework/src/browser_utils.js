...
var SmartJS_BrowserUtils_NotifyLoadError = false; // if set to false will not raise notifications on ajax load errors
...
*/
var SmartJS_BrowserUtils = new function() { // START CLASS :: v.181015
 ...
 * @static
 * @param 	{String} 	the_form_id 			The form ID | false

...
this.textArea_addLimit = function(y_field, y_maxlimit) {
	...
	//--
	jQuery('#' + y_field).wrap(
		'<div style="position:relative!important; text-align:right!important;"></div>'
	).after(
		'<br><input title="TextArea Limit: ' + SmartJS_CoreUtils.escape_html(y_maxlimit) + '" type="text" readonly disabled id="' + SmartJS_CoreUtils.escape_html(y_countfield) + '" size="6" maxlength="5" value="' + SmartJS_CoreUtils.escape_html(y_maxlimit) + '" style="cursor:help!important; padding:0px!important; font-size:10px!important; text-align:center!important; position:relative!important; margin-top:-7px!important; opacity:0.75;">'
...
/* To be tested: on reaching content waypoint will trigger some action ... */

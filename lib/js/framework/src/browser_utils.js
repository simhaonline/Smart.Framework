...
*/
var SmartJS_BrowserUtils = new function() { // START CLASS :: v.181116.r2
...
/*	var blob = null;
	try {
		...
		alert('WARNING: Browser does not support blob downloads');
		return;
	} //end try catch
	//--
	var wURL = null;
	try {
		...
		alert('WARNING: Browser does not support dynamic URL objects');
		return;
	} //end try catch
	//--
	var xURL = null;
	try {
		...
		alert('WARNING: Browser does not support dynamic URL create objects');
		return;
	} //end try catch */
	//--

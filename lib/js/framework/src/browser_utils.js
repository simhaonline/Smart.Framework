...
*/
var SmartJS_BrowserUtils = new function() { // START CLASS :: v.20190219
				...
				setTimeout(function(){
						...
						if(isSVG) {
							if(String(the_frd.result).length <= (1024 * 1024 * imgMaxResizeMBSize)) {
								...
								$upldr.val('');
								$imgpw.text('Image Uploader WARNING: SVG Size is higher than allowed size: ' + String(the_frd.result).length + ' Bytes');
							} //end if else
							if(clearPreview) {
								$imgpw.empty().html('');
							} //end if

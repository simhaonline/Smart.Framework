...
*/
var SmartJS_BrowserUtils = new function() { // START CLASS :: v.20190114
 ...
 * @param 	{Boolean} 	y_withCredentials 		*Optional* Send Credentials (CORS) ; default is FALSE ; set to TRUE to send XHR Credentials
 * @return 	{Object} 							The Ajax XHR Request Object ; The following methods must be bind to this object and redefined:
 * 		.done: 		function(msg) {}
 * 		.fail: 		function(msg) {}
 * 		.always: 	function(msg) {}
...
this.Ajax_XHR_PostMultiPart_To_URL = function(y_url, y_data_type, y_data_formData, y_withCredentials) {
	...
	//--
	var theWithCredentials = false;
	if(y_withCredentials === true) {
		theWithCredentials = true;
	} //end if
	//--
	return jQuery.ajax({
		async: true,
	...
	//	timeout: 0, // by default is zero ; let this be set globally via ajaxSetup
		...
		url: y_url,
		//--
		withCredentials: theWithCredentials, // allow send credentials (CORS)
		//--
		contentType: false,
		processData: false,

...
/**
 * @desc Detect if a Browser support Cookies or have the Cookies enabled.
...
/**
 * @desc Detect if the Browser is on a mobile device.
...
/*
 * @desc Detect if the Internet Explorer matches minimum required version: at least IE9.
 * @hint If fail, an alert will be shown.
 *
 * @memberof Test_Browser_Compliance

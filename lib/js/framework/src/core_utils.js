...
*/
var SmartJS_CoreUtils = new function() { // START CLASS :: v.181214
 ...
 */
this.escape_css = function(str) { // v.181214
	//--
 ...
 */
this.stringContains = function(str, search, pos) { // v.181214
	//--
 ...
 * @return 	{String} 				The processed string
 */
this.renderMarkersTpl = function(template, arrobj, urlescaped) { // v.181214
	//--
	var debug = false;
	//--

...
*/
var SmartJS_CoreUtils = new function() { // START CLASS :: v.181217
 ...
 */
this.stringContains = function(str, search, pos) { // v.181217
	//--
 ...
 * @return 	{String} 				The processed string
 */
this.renderMarkersTpl = function(template, arrobj, urlescaped) { // v.181217
	//--
	var debug = false;
	//--

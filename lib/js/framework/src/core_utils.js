...
*/
var SmartJS_CoreUtils = new function() { // START CLASS :: v.20190930.r2
 ...
 * @return 	{String} 				The processed string
 */
this.renderMarkersTpl = function(template, arrobj, urlescaped) { // v.20191010
	//--
	var debug = false;
	//--
	if((typeof template === 'string') && (typeof arrobj === 'object')) {
		...
		//	} //end if
			...
			marker = null;
			markers = null;
			//-- replace specials: R N TAB SPACE

...
* CLASS :: Core Utils
*
* @package Smart.Framework/JS/Core
*
...
/**
 * @desc Generate a base36 10-chars length UUID
 *
...
/**
 * @desc Check if a number is valid: Finite and !NaN
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Trim a string (at begining or end by any whitespace: space \ n \ r \ t)
 *
 * @memberof SmartJS_CoreUtils
 * @method stringTrim
 * @static
...
/**
 * @desc Make uppercase the first character of a string
...
/**
 * @desc Make uppercase the first character of each word in a string while making lowercase the others
...
/**
 * @desc Split string by colon with trimming pre/post
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Split string by equal with trimming pre/post
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Split string by comma with trimming pre/post
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Split string by semicolon with trimming pre/post
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Replace all occurences in a string - Case Sensitive
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Replace all occurences in a string - Case Insensitive
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Get the first element from an Array
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Get the last element from an Array
 *
 * @memberof SmartJS_CoreUtils
 * @method arrayGetLast
 * @static
...
/**
 * @desc Format a number as INTEGER
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Format a number as DECIMAL
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc Safe escape URL Variable (using RFC3986 standards to be full Unicode compliant).
...
/*
 * @desc Convert special characters to HTML entities.
 * @summary Depending on the flag parameter, the following values will be converted to safe HTML entities:
 * 		ENT_COMPAT: 	< > & "
 * 		ENT_QUOTES: 	< > & " '
 * 		ENT_NOQUOTES: 	< > &
...
/**
 * @desc Convert special characters to HTML entities.
 * @summary These values will be converted to safe HTML entities: < > & "
...
/**
 * @desc Convert special characters to escaped entities for safe use with Javascript Strings.
...
/**
 * @desc Replace new lines \ r \ n ; \ n with the <br> html tag.
 ...
 * @hint This is compatible with the PHP ucfirst() function.
 *
 * @memberof SmartJS_CoreUtils
 * @method ucfirst
 * @static
...
/**
 * @desc Decodes an UTF-8 string to ISO-8859-1
 *
 * @memberof SmartJS_CoreUtils
 * @method utf8_decode
 * @static
...
/**
 * @desc Quote regular expression characters in a string.
...
/**
 * @desc Regexp Match All occurences.
...
/**
 * @desc Find if a string contains another sub-string
 *
 * @memberof SmartJS_CoreUtils
...
/**
 * @desc De-Accent a latin-based Unicode string
 * @summary Will convert all accented characters in UTF-8 / ISO-8859-* with their unnaccented versions into ISO-8859-1
...
/**
 * @desc Render Simple Markers-TPL Template + Comments + Specials (only markers replacements with escaping or processing syntax and support for comments and special replacements: SPACE, TAB, R, N ; no support for IF / LOOP / INCLUDE syntax since the js regex is too simplistic and this can be implemented using real js code)
 * @summary This is compatible just with the REPLACE MARKERS of Smart.Framework PHP server-side Markers-TPL Templating for substitutions on client-side, except the extended syntax as IF/LOOP/INCLUDE.
 * @hint To be used together with the server-side Markers-TPL templating, to avoid the server-side markers to be replaced as `［###MARKER###］` will need the template to be escape_url+escape_js and 3rd param: urlescaped = TRUE
 *
 * @memberof SmartJS_CoreUtils
 ...
 * @param 	{Boolean} 	urlescaped 		If TRUE will do a decodeURIComponent() over template string (apply if TPL is sent as URL Encoded)
 ...
 * @return 	{String} 					The processed string
 */
this.renderMarkersTpl = function(template, arrobj, urlescaped, revertsyntax) { // r.20191115
	//--
	var debug = false;
	//--
...
/*
 * @desc Revert from Prepare a value or a template by escaping syntax
 *
 * @memberof SmartJS_CoreUtils
...
/*
 * @desc Prepare a value or a template by escaping syntax
 *
 * @memberof SmartJS_CoreUtils
...
/*
 * @desc Prepare a HTML template for display in no-conflict mode: no syntax / markers will be parsed
 * @summary To keep the markers and syntax as-is but avoiding conflicting with real markers / syntax it will encode as HTML Entities the following syntax patterns: [ ] # % @
...
/**
 * @desc Sort a stack (array / object / property) using String Sort algorithm
 *
 * @memberof SmartJS_CoreUtils
 * @method textSort
 * @static
...
/**
 * @desc Sort a stack (array / object / property) using Numeric Sort algorithm
 *
 * @memberof SmartJS_CoreUtils
 * @method numericSort
 * @static
...
/**
 * @desc Format a date object into a string value.
 * @summary The format can be combinations of the following:
...
/**
 * @desc Determine a date by a Date object or Expression
 * @summary Valid date objects or expressions:

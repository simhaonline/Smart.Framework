...
var setIV = function(key) {
	...
	var data = String(SmartJS_Base64.encode(String(SmartJS_CryptoHash.sha1('@SmartFrameworkCrypto/BlowFish:' + key + '#' + SmartJS_CryptoHash.sha1('BlowFish-iv-SHA1' + key) + '-' + SmartJS_CryptoHash.md5('BlowFish-iv-MD5' + key) + '#'))).substring(1, (8+1)));
	//console.log('iV: ' + data);
	//-- pre-process
...
var setKey = function(key) {
	...
	r_key = String(SmartJS_CryptoHash.sha512(key).substring(13, (29+13)) + SmartJS_CryptoHash.sha1(key).substring(13, (10+13)) + SmartJS_CryptoHash.md5(key).substring(13, (9+13)));

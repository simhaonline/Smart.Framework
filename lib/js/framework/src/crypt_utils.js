...
var setIV = function(key) {
	...
	var data = String(SmartJS_CryptoHash.sha1('@SmartFrameworkCrypto/BlowFish:' + key + '#' + SmartJS_CryptoHash.sha1('BlowFish-iv-SHA1' + key) + '-' + SmartJS_CryptoHash.md5('BlowFish-iv-MD5' + key) + '#').substring(29, (8+29)));
	//console.log('iV: ' + data);
	//-- pre-process

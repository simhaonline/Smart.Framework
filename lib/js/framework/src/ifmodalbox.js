...
var version = 'r.20191118';


//-- setup
this.param_LoaderBlank = 'lib/js/framework/blank.html';			// loader html blank page or empty
this.param_LoaderImg = 'lib/js/framework/img/loading.svg';		// loader image or empty
this.param_CloseImg = 'lib/js/framework/img/close.svg';			// close image
this.param_CloseAlign = 'right'; 								// close align: 'left' or 'right'
this.param_CloseBtnAltHtml = ''; 								// alternate html code for the modal close button ...
this.param_vAlign = 'top'; 										// vAlign: 'top' or 'middle' / 'center'
this.param_DelayOpen = 850;										// modal open delay (500 ... 1000) ; default is 750
this.param_DelayClose = 500;									// modal close delay (250 ... 750) ; default is 500
this.param_CssOverlayBgColor = '#333333';						// modal overlay bg color #hexhex
 ...
 * @static
 *
 * @return {String} The status of the Modal Box as: 'visible' | ''
 */
...
/*
 * Per-Instance Before Unload custom Handler

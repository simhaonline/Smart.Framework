...
// file: feature-select.js
// http://openplans.github.io/Leaflet.FeatureSelect

// bug fixed by unixman (new created features selection)
...
L.FeatureSelect = L.Class.extend({
	...
	_checkIntersections: function() {
		...
		this.options.featureGroup.eachLayer(function(layer) {
			...
			//-- bugfix by unixman (new created features appear not to have this by default !!!

...
// Leaflet VectorGrid v.1.3.0
// https://github.com/Leaflet/Leaflet.VectorGrid

// NOTICE:
// Before VectorGrid, loading vector tiles in Leaflet could only be done with the Leaflet.MapboxVectorTile or the Hoverboard plugin,
// but neither of those works with Leaflet 1.0.0 (or greater). VectorGrid leverages the GridLayer feature introduced in Leaflet 1.0.0.

/*!
 * (c) 2017 ivan@sanchezortega.es
 * License: "THE BEER-WARE LICENSE": ivan@sanchezortega.es wrote this file.
 * As long as you retain this notice you can do whatever you want with this stuff. (If you ever meet him some day, and you think this stuff is worth it, you can buy him a beer in return.)
 */

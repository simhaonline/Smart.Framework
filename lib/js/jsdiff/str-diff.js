...
// Smart Str(ing) Diff
// (c) 2015-2019 unix-world.org # r.20190122
...
var Smart_StrDiff = new function() { // START CLASS
	...
	function diffString(o, n) {
		...
		o = '\n' + SmartJS_CoreUtils.stringTrim(o);
		n = '\n' + SmartJS_CoreUtils.stringTrim(n);
		...
		if(out.n.length == 0) {
			...
			for(var i = 0; i < out.n.length; i++ ) {
				if(out.n[i].text == null) {
					...
					str += ' ' + SmartJS_CoreUtils.escape_html(out.n[i].text) + nSpace[i] + pre;
				} //end if else
			} //end for
		} //end if else
			...
			str = SmartJS_CoreUtils.stringTrim(str);

/* ColReorder 1.5.0 (modified by unixman)
...
var ColReorder = function( dt, opts )
{
	...
	// Convert from camelCase to LatinExtended, just as DataTables does
	var camelToLatinExtended = $.fn.dataTable.camelToLatinExtended;
	if ( camelToLatinExtended ) {
		camelToLatinExtended( ColReorder.defaults, ColReorder.defaults, true );
		camelToLatinExtended( ColReorder.defaults, opts || {} );
	}

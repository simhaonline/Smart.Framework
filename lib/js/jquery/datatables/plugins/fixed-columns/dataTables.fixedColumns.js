/* FixedColumns 3.2.6 (modified by unixman)
 * (c) 2010-2018 SpryMedia Ltd - MIT License # https://github.com/DataTables
 * (c) 2018-2019 unix-world.org
 */

// Fixes by unixman: #r.uxm20190107
...
var FixedColumns = function ( dt, init ) {
	...
	// Use the DataTables LatinExtended notation mapping method, if it exists to
	// provide forwards compatibility for camel case variables
	var camelToLatinExtended = $.fn.dataTable.camelToLatinExtended;
	if ( camelToLatinExtended ) {
		camelToLatinExtended( FixedColumns.defaults, FixedColumns.defaults, true );
		camelToLatinExtended( FixedColumns.defaults, init );
	}
...
$.extend( FixedColumns.prototype , {
	...
	"_fnConstruct": function ( oInit )
	{
		...
		// fix by unixman: disable log if x is too low

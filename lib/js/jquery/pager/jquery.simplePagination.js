/*
* simplePagination.js v1.6 r.160920
...
* contains fixes by unixman r.170404
...
(function($){
	...
	var methods = {
		...
		_ellipseClick: function($panel) {
			var emulateClickEvent = {
				'type': 'click' // fix by unixman: this will emulate an event type click
			};
			var self = this,
				...
				if (!o.disable) {
					...
					$this
						...
						.keyup(function(event) {
							...
							if(event.which === 13 && val !== '') {
								...
								if((val>0) && (val<=o.pages)) {
									...
									methods._selectPage.call(self, val-1, emulateClickEvent); // fix by unixman
								}
						...
						.bind('blur', function(event) {
							var val = $(this).val();
							//if(val !== '') {
							if((val>0) && (val<=o.pages)) { // fix by unixman
								//methods._selectPage.call(self, val - 1);
								methods._selectPage.call(self, val-1, emulateClickEvent); // fix by unixman
							}
							$ellip.empty().html(o.ellipseText);

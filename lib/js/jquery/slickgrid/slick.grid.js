 ...
 * SlickGrid v1.4.3.1.smart.180514 : Smart.Framework
...
(function($) {
	...
	function SlickGrid(container,data,columns,options) {
		...
		function measureCellPaddingAndBorder() {
			...
			headerColumnWidthDiff += 2; // fix by unixman to substract the borders
			...
			cellWidthDiff += 2; // fix by unixman to substract the borders

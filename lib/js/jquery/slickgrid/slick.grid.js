 ...
 * SlickGrid v1.4.3.1.smart.20200501 : Smart.Framework
	...
	function SlickGrid(container,data,columns,options) {
		...
		function createColumnHeaders() {
			...
			for(i = 0; i < columns.length; i++) {
				...
				columnsById[m.id] = i;
				var header = $('<div class="slick-header-column c' + i + ' slick-state-default' + (m.cssHeadClass ? ' ' + SmartJS_CoreUtils.escape_html(m.cssHeadClass) : '') + '" id="' + SmartJS_CoreUtils.escape_html('' + uid + m.id) + '"></div>')
		...
		function appendRowHtml(stringArray,row) {
			...
			stringArray.push('<div class="slick-uiwidget-content ' + SmartJS_CoreUtils.escape_html(css) + '" row="' + SmartJS_CoreUtils.escape_html(row) + '" style="top:' + Math.ceil(options.rowHeight*row-offset) + 'px">');
			for(var i=0, cols=columns.length; i<cols; i++) {
				...
				stringArray.push('<div class="' + SmartJS_CoreUtils.escape_html(cellCss) + '">');

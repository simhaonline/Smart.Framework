	...
	var SlickEditor = {
		...
		ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
			...
			if (columnDef.width < 50)
				return (resources.length > 1 ? "<center><img src='lib/js/jquery/slickgrid/images/user_identity_plus.gif' " : "<center><img src='lib/js/jquery/slickgrid/images/user_identity.gif' ") +

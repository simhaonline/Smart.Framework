// FORMATTERS & EDITORS for SlickGrid v1.4.3.1.smart.170323
// Fixes:
// 	* 160413: added selection handler
// 	* 170323: replaced out references to $.ui(.keyCode)
...
(function($) {
	...
	var SlickEditor = {
		...
		BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
			return value ? "<img src='lib/js/jquery/slickgrid/images/tick.png'>" : "";
		},
		...
		TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
			...
			return spacer + " <img src='lib/js/jquery/slickgrid/images/expand.gif'>&nbsp;" + value;
		},
		...
		ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
			...
			if (columnDef.width < 50)
				return (resources.length > 1 ? "<center><img src='lib/js/jquery/slickgrid/images/user_identity_plus.gif' " : "<center><img src='lib/js/jquery/slickgrid/images/user_identity.gif' ") + " title='" + resources.join(", ") + "'></center>";
			else
				return resources.join(", ");
		},

		StarFormatter : function(row, cell, value, columnDef, dataContext) {
			return (value) ? '<img src="lib/js/jquery/slickgrid/images/bullet_star.png" align="absmiddle">' : '';
		},
		...
		DateCellEditor : function(args) {
			...
			this.init = function() {
				...
				$input.datepicker({
					...
					buttonImage: "lib/js/jquery/slickgrid/images/calendar.gif",
		...
		StarCellEditor : function(args) {
			...
			this.init = function() {
				$input = $("<IMG src='lib/js/jquery/slickgrid/images/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />")
		...
		TextCellSelector : function(args) {
			var $input;
			var defaultValue;
			var scope = this;

			this.init = function() {
				$input = $('<input type="text" class="ux-field" style="width:100%!important; height:100%!important; margin:0!important;" readonly>')
					.appendTo(args.container)
					.bind("keydown.nav", function(e) {
						if (e.keyCode === SE_Keycode_LEFT || e.keyCode === SE_Keycode_RIGHT) {
							e.stopImmediatePropagation();

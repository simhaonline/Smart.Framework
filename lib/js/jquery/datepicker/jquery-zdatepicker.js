 ...
 *  v.1.9.5.1.smart/2016-09-03
 *  Includes many fixes by unixman:
	...
	$.Zebra_DatePicker = function(element, options) {
		...
		var init = function(update) {
			...
			// calendar is past only, ending today
				...
				} else if(!tmp_end_date && plugin.settings.direction[1] !== false && $.isArray(plugin.settings.direction)) { // if have information about the ending date

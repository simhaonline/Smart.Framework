...
// unixman :: v.2015.07.29 : many fixes includding allow script tags: <script></script>
...
(function ($) {
	...
	$.cleditor = {
		...
		defaultOptions: {
			...
			fonts:        // font names in the font popup
						  ...
						  "Arial, Tahoma, Verdana, Courier New", // unixman
	...
	function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
		...
		// URL
			...
			$popup.html('<label>Enter URL:<br><input type="text" value="http://" style="width:200px; font-size:13px;"></label><br><input type="button" value="Make Hyperlink">');
			popupTypeClass = PROMPT_CLASS;
		}

		// Paste as Text
		else if (popupName === "pastetext") {
			$popup.html('<label>Paste your code here:<br><textarea rows="7" style="width:240px; font-size:13px;"></textarea></label><br><input type="button" value="Insert Code">');
			popupTypeClass = PROMPT_CLASS;
		}
	...
	function refresh(editor) {
		...
		// Create a new iframe
		if(webkit) {
			var the_html_frame = '<iframe frameborder="0" src="javascript:true;" sandbox="allow-pointer-lock allow-popups allow-same-origin allow-top-navigation allow-scripts"></iframe>'; // unixman: Webkit misbehaves and block parent JS without this, but executing JS is not what we want in the editor ...
		} else { // Firefox, IE
			var the_html_frame = '<iframe frameborder="0" src="javascript:true;" sandbox="allow-pointer-lock allow-popups allow-same-origin allow-top-navigation"></iframe>';
		} //end if else
		...
		if (ie || iege11) {
			...
			$frame.blur(function () {
				...
				updateTextArea(editor, true); // unixman
	...
	function updateFrame(editor, checkForChange) {
		...
		*/
		...
		//-- unixman :: we also wish to prettify HTML code {{{SYNC-HTML-CLEAN}}}

...
(function($) {
	...
	$.cleditor.buttons.wordcount = {
		...
		popupContent: '<table width="225"><tr><td><b>Words Count: </td><td align="right"><input type="text" id="cledit_uxm_word_counter" value="#" style="width:96px; text-align:right; padding-left:5px; padding-right:5px;" readonly></td></tr>' +
					  '<tr><td><b>Chars Count: </td><td align="right"><input type="text" id="cledit_uxm_wordchar_counter" value="#" style="width:96px; text-align:right; padding-left:5px; padding-right:5px;" readonly></td></tr></table>',

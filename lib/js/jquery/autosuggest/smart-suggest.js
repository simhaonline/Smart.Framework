	...
	setTimeout(function(){
		...
		jQuery.ajax({
			...
			success: function(answer) {
				...
				for(var i=0; i<(answer.length); i++) {
					//--
					suggest += '<tr valign="top" onclick="SmartAutoSuggest.handleSelection(\'' + SmartJS_CoreUtils.escape_js(y_type) + '\', \'' + SmartJS_CoreUtils.escape_js(theID) + '\', \'' + SmartJS_CoreUtils.escape_js(answer[i].id) + '\', \'' + SmartJS_CoreUtils.escape_js(answer[i].value) + '\', \'' + SmartJS_CoreUtils.escape_js(answer[i].label) + '\', \'' + SmartJS_CoreUtils.escape_js(answer[i].data) + '\', \'' + SmartJS_CoreUtils.escape_js(evcode) + '\');" title="' + SmartJS_CoreUtils.escape_html(el+1) + '">';
					//--
					suggest += '<th>';

 ...
 *
 * @param STRING 	$ystr			:: The string
 * @param ENUM 		$ychar_from		:: One of the: UTF-8, ISO-8859-1, ISO-8859-15, ISO-8859-2, ISO-8859-9, ISO-8859-3, ISO-8859-4, ISO-8859-5, ISO-8859-6, ISO-8859-7, ISO-8859-8, ISO-8859-10, ISO-8859-11, ISO-8859-13, ISO-8859-14, ISO-8859-16, UTF-7, ASCII, SJIS, EUC-JP, JIS, ISO-2022-JP, EUC-CN, ISO-2022-KR, KOI8-R, KOI8-U
 * @param ENUM 		$ychar_to		:: One of the: UTF-8 or another valid charset
...
//================================================================
/**
 * Provide the Unicode Accented Characters Table
 *
 * @access 		private
 * @internal
 *
 * @return ARRAY 			:: The Unicode Accented to Unaccented Characters Map
 */
public static function accented_chars() {
	//-- v.160106
	return array(
		'á' => 'a',
		'â' => 'a',
...
//================================================================
/**
 * Provide the Unicode Accented HTML-Entities Table
 *
 * @access 		private
 * @internal
 *
 * @return ARRAY 			:: The Unicode Accented to Unicode HTML-Entities Map
 */
public static function accented_html_entities() {
	//-- v.160106
	return array(
		'á' => '&#225;',
		'â' => '&#226;',

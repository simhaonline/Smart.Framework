...
//--
if(!defined('SMART_FRAMEWORK_PDF_GENERATOR_APP')) {
	die('A required INIT constant has not been defined: SMART_FRAMEWORK_PDF_GENERATOR_APP');
} //end if
if(!defined('SMART_FRAMEWORK_PDF_GENERATOR_MODE')) {
	die('A required INIT constant has not been defined: SMART_FRAMEWORK_PDF_GENERATOR_MODE');
} //end if
//--
 ...
 *
 * @depends 	executables: HTMLDoc 1.8.x ; classes: Smart, SmartUtils, SmartFileSysUtils, SmartHtmlParser
 * @version 	v.160204
 * @package 	Exporters
 *
 */

...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.7.3'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2016.10.05'); // this is the real release version date

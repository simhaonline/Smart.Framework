...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.7.5'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2017.01.09'); // this is the real release version date

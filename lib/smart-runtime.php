...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.1.5'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2016.03.11'); // this is the real release version

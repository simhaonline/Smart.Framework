...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.7.6'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2017.02.02'); // this is the real release version date

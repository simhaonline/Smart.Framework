...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.7.1'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2016.09.21'); // this is the real release version date

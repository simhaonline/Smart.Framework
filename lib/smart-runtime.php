...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.3.2'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2016.06.28'); // this is the real release version

...
//--
define('SMART_FRAMEWORK_RELEASE_TAGVERSION', 'v.2.3.7.7'); // this is the real release version tag
define('SMART_FRAMEWORK_RELEASE_VERSION', 'r.2017.02.22'); // this is the real release version date

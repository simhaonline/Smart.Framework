...
//--------------------------------------- HANDLERS
define('SMART_FRAMEWORK_PERSISTENT_CACHE_HANDLER', false); 									// Persistent Cache Handler ; If set to FALSE will use no handler ; If set otherwise can use Built-In: 'redis' or 'dba' ; or a Custom handler can be set as (example): 'modules/app/persistent-cache-custom-adapter.php'
...
define('SMART_FRAMEWORK_FILE_LOCKTIME', 	59);											// File wrtiting LockTime (a reasonable time is 59 seconds for high load websites ; for medium can be 30 seconds ; for low traffic website can be 15 seconds)
